...
This is the advanced Apache setup. Most users should follow the simpler PHP built-in server guide in [php.md](php.md). Use this only if you already have Apache running and prefer it.
...
If you do not already have Apache and PHP working locally, the PHP built-in server guide is usually easier:

- [php.md](php.md)

Docker is also available if you prefer containers:
